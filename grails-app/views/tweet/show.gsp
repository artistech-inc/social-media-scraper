...
<html>
    ...
    <body>
        ...
        <div id="show-tweet" class="content scaffold-show" role="main">
            ...
            %{--<g:form resource="${this.tweet}" method="DELETE">--}%
                %{--<fieldset class="buttons">--}%
                    %{--<g:link class="edit" action="edit" resource="${this.tweet}"><g:message code="default.button.edit.label" default="Edit" /></g:link>--}%
